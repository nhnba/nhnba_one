# Generated by Django 2.2.16 on 2020-09-28 08:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dating_location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('深圳', '深圳'), ('成都', '成都'), ('西安', '西安'), ('武汉', '武汉'), ('沈阳', '沈阳')], default='上海', max_length=10, verbose_name='⽬标城市')),
                ('dating_gender', models.CharField(choices=[('male', '男'), ('female', '女')], default='female', max_length=10, verbose_name='匹配的性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('北京', '北京'), ('上海', '上海'), ('深圳', '深圳'), ('成都', '成都'), ('西安', '西安'), ('武汉', '武汉'), ('沈阳', '沈阳')], default='上海', max_length=10, verbose_name='常居地')),
            ],
        ),
    ]
